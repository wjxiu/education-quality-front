    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
            <el-form-item label="id" prop="id">
                <el-input v-model="queryParams.id" placeholder="请输入" clearable @keyup.enter.native="handleQuery" />
            </el-form-item>

            <el-form-item label="评价项" prop="evalItem">
                <el-input type="textarea" v-model="queryParams.evalItem" placeholder="请输入" clearable
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                <el-form-item label="评价选项" prop="evalItem">
                    <el-input type="textarea" v-model="form.evalItem" placeholder="请输入" />
                </el-form-item>
            </el-form>
    ...
    methods: {
        ...
        getList() {
            ...
            listEval(this.queryParams).then(response => {
                this.evalList = response.data.list;
        ...
        handleDelete(row) {
            ...
            this.$confirm('是否确认删除评分管理编号为"' + ids + '"的数据项？').then(function () {
                return delEval(ids);
            }).then(() => {
                this.getList();
                this.$message.success('新增成功')
